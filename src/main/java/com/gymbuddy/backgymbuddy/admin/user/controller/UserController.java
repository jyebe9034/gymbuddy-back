...
public class UserController extends BaseController {
     ...
     * 아이디 중복체크
     */
    @GetMapping(USER_API + "/duplicateIdentity/{identity}")
    public ResponseEntity<Map<String, Object>> checkDuplicateIdentity(@PathVariable("identity") String identity) {
    ...
    public ResponseEntity<Map<String, Object>> sendAuthNumber(@RequestBody UserDto user) {
        ...
        String content = "<div style='background-color: #00AD84; border:4px solid #231815; text-align: center;'>" +
                "<div><img src='gymbuddy.co.kr/resources/img/logo.png' alt='운동친구 로고' style='margin:60px 0 50px 0;' width='140px'></div>" +
